...
class TenantDocumentationTest extends TestCase
{
    ...
    public function test_can_copy_property_media_to_before_documentation()
    {
        ...
        // Fake existing property media file (public/optimized version,
        // matching the real Storage layout produced by ImageWatermarkService).
        Storage::disk('public')->put('properties/1/test.jpg', 'fake content');

        $propMedia = PropertyMedia::create([
            'property_id' => $property->id,
            'type' => 'IMAGE',
            'original_path' => 'properties/1/originals/test.jpg',
            'public_path' => 'properties/1/test.jpg',
            'is_cover' => false,
            'sort_order' => 1,
        ]);
        ...
        Storage::disk('public')->assertExists('properties/1/test.jpg');
